...
export async function GET(request: Request) {
  try {
    ...
    const updatedProducts = await Promise.all(
      products.map(
        async (currentProduct: { url: string; priceHistory: any }) => {
